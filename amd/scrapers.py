...
class AMDGamingScraper:
    ...
    def fetch_promotions(self) -> PromotionsResponse:
        ...
        result: PromotionsResponse = PromotionsResponse.model_validate(response.json())  # pyright: ignore[reportUnknownMemberType]
